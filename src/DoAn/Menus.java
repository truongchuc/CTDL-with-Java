...
public class Menus {
	...
	public void menuDSLKD() {
		...
		do {
			...
			System.out.println("║ 10. Chỉnh sửa thông tin sinh viên      ║");
			...
			case 5:
				...
				if (result != null) {
					System.out.println("Thông tin sinh viên: " + result.getHoten() + " - Toán: " + result.getDiemToan()
							+ ", Văn: " + result.getDiemVan() + ", Anh: " + result.getDiemAnh());
				} else {
			...
			case 9:
				...
				scanner.nextLine();
				obj.insert(maSV1, hoten, diemToan, diemVan, diemAnh);
				obj.displaySortedResults();
				break;
			case 10:
				System.out.print("Nhập mã sinh viên cần chỉnh sửa thông tin: ");
				String maSVChinhSua = scanner.nextLine();
				obj.chinhSuaThongTin(maSVChinhSua);
				obj.printlist();
				break;
			case 0:
				break;
	...
	public void menuCay() {
		...
		do {
			...
			System.out.println("║ 4. Danh sách SV có điểm trên 5                             ║");
